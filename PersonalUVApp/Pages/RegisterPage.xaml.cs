...
namespace PersonalUVApp.Pages
{
    public partial class RegisterPage //: ContentPage
    {
        ...
        public static readonly BindableProperty UserProperty = BindableProperty.Create(nameof(User), typeof(UserModel), typeof(RegisterPage));

//        public Command GetLocationCommand { protected set; get; }
        ...
        private void Register(object obj)
        {
            ...
            DisplayAlert("Success", "Registration has been done successfully", "OK");
            App.UvApp.PopPage();
        }
